		...
		<div class="row px-xl-5">
			...
			<div class="col-lg-9 col-md-8">
				<div class="row pb-3">
						...
						<div class="product-item bg-light mb-4">
							<div class="product-img position-relative overflow-hidden">
								<img class="img-fluid w-100"
									...
									alt="">
								<div class="product-action">
									<a class="btn btn-outline-dark btn-square <%="Y".equals(vo.getJjim()) ? "addJJim" : ""%>"
										onclick="jjimClick('<%=list.get(i).getT_no()%>', this)" href="#"><i
										class="far fa-heart"></i></a> <a
					...
					<input type="button" style="float:right;" value="상품 등록" onclick="prodInsert()">
			</div>
			<!-- Shop Product End -->
		</div>
	</div>
